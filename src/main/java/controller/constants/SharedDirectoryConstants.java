...
public abstract class SharedDirectoryConstants {
    public static final String GC_USER_CANT_ADD_HIMSELF = "The owner can not add himself as member!";
    public static final String GC_NOT_VALID_USER = "The entered email do not exists!";
    ...
    public static final String GC_SHARED_DIR_CREATED = "Shared directory successful created!";
}
